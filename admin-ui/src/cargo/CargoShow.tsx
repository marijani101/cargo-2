...
import { CARGO_TITLE_FIELD } from "./CargoTitle";
import { CUSTOMER_TITLE_FIELD } from "../customer/CustomerTitle";

export const CargoShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Parcel" target="CargoId" label="Parcels">
